    ...
    other = {'rf': RandomForestForecaster(targets,
             ...
             'lightgbm_default_hyperparams':
                 LightGBMForecaster(targets,
                                    ...
                                    update_freq=update_freq,
                                    verbose=3),
             'timesfm': TimesFMForecaster(targets, lead_time, forecast_len, data_freq, features=timesfm_features),
             'timesfm_no_cov': TimesFMForecaster(targets, lead_time, forecast_len, data_freq, features=timesfm_features_no_cov)
...
if __name__ == '__main__':
    ...
    df = load_data()
    test_period = ('2020-01-01', '2020-01-7')
    ...
    train_eval_tool(mode,
                    ...
                    mlflow_registry_update_mode="always" #"better_only"
                    )
